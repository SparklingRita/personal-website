        ...
        <View style={styles.left}>
          <View style={{ alignItems: "center" }}>
            ...
            <View style={styles.section}>
              <Text
                style={{ fontSize: 16, fontWeight: 700, color: titleColor }}
              >
                {cvData.name}
              </Text>
              <View style={styles.contactEntry}>
                <FontAwesomeIcon faIcon={faLocationDot} style={styles.icon} />
                <Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.contactEntry}>
              <FontAwesomeIcon faIcon={faGlobe} style={styles.icon} />
            ...
            <View style={styles.contactEntry}>
              <FontAwesomeIcon faIcon={faGithub} style={styles.icon} />
          ...
          <View style={styles.section}>
            ...
            <Text style={{ fontWeight: 400, marginBottom: 2 }}>
              Programming
            </Text>
            ...
            {cvData.skills.programming.map((skill) => (
              ...
              >
                {/* Skill name */}
                <Text style={{ color: titleColor, marginRight: 6 }}>
                  {skill.name}
                </Text>
                  ...
                  {Array.from({ length: 5 }).map((_, i) => (
                    <View
                      ...
                      style={{
                        ...
                        backgroundColor:
                          i < skill.level ? iconColor : textColor, // filled or empty
                      }}
                    />
                  ))}
                </View>
            ...
            <Text style={{ fontWeight: 400, marginBottom: 2, marginTop: 5 }}>
              Other
            </Text>
              ...
              <View key={e.title} style={styles.entry}>
                ...
                <View>
                  <View style={styles.educationEntry}>
                    <FontAwesomeIcon faIcon={faCalendar} style={styles.icon} />
                    <Text>{e.date}</Text>
                  </View>
